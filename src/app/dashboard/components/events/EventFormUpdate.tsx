...
import updateEventsAction from "@/actions/events/updateEvent.action";
...
export const EventFormUpdate = ({ clients, users, event }: Props) => {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    // });
    const response = await updateEventsAction({
      id: event._id,
      values,
    });
